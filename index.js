...
const firstName = "Elsabeth";
const lastName = "Kidane";
const homeCountry = "Eritrea";
...
/*const mySentence = "My name is ".concat(fullName)+ "." + " " + "I am from"+ " "
.concat(homeCountry)+ "." ; */
...
let firstname=(firstName.charAt(firstName.length-1)).toUpperCase()
let lastname=(lastName.charAt(lastName.length-1)).toUpperCase()
let funkyInitials=`${firstname}${lastname}`
...
//QUESTION 9. Without changing the values of var1 or var2, add var1 and var2 so that they add up to 42 as an integer and are stored in the variable var3.
